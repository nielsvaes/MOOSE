...
function CCMISSIONDB:Add(group_table, category, country_id, coalition_id, extra_group_settings)
    ...
    extra_group_settings = extra_group_settings or {}

    table.merge(group_table, extra_group_settings)
