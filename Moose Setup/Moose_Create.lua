...
LoaderFile:write( os.date("--- %Y-%m-%d %H:%M:%S\n") )
LoaderFile:write( "--- Generated by Coconut Cockpit\n" )
LoaderFile:write( "--- https://github.com/nielsvaes/CCMOOSE\n\n" )
...
while( MooseSource ) do
  ...
  if MooseSource ~= "" then
    MooseSource = string.match( MooseSource, "'(.+)'" )
    print(MooseSource)
